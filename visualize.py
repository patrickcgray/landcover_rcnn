...
(22, (200,0,0)), # low intensity developed ~ darker red
(23, (150,0,0)), # medium intensity developed ~ darker darker red
(24, (100,0,0)), # high intensity developed ~ darker darker darker red
...
(95, "Emergent Herbaceous Wetlands"),
    ...
    def print_a_tile(self, landsat_index, class_index, tile_size):
        ...
        tile = self.__read_from_raster(self.landsat[landsat_index], c_landsat-buffer, r_landsat-buffer, tile_size)
        tile_normalized = self.__normalize_rgb(tile)
        ax_c = self.__plot_a_tile(tile_normalized)
    ...
    def __read_from_raster(self, raster, column_start, row_start, tile_size):
        ...
        return w
    def __plot_a_tile(self, tile, colors = None):
        fig, ax = plt.subplots(figsize=(10, 10))
        ...
        if colors == None:
            ...
            print("sanity check print middle pixel {}".format(tile[math.ceil(h/2)][math.ceil(h/2)]))
