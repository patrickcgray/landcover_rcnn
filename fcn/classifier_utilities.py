                ...
                if np.isnan(s1_tile).any() == True:
                    ...
                    for h in range(tile_height):
                        ...
                        for w in range(tile_width):
                            ...
                            if(label_image[0, tileRow, tileCol].isnan().any() or label_image[0, tileRow, tileCol] == 0):
                                flag = False
                    ...
                    if not flag:
                        ...
                        print(label_masks)
                        np.subtract(label_masks,-1)
                        label_batch[b] = to_categorical(label_masks, num_classes=class_count);
                        image_batch[b] = np.dstack( ( reshaped_tile, reshaped_s1_tile, reshaped_dem_tile ) )
                        b += 1
        yield (image_batch, label_batch)
